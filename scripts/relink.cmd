...
SetLocal
@REM ================================================================
@REM  重建 opencode-codebuddy-auth 的缓存目录链接 (JUNCTION)
@REM
...
SET "PLUGIN_NAME=opencode-codebuddy-auth"
SET "PLUGIN_SPEC=opencode-codebuddy-auth@latest"
SET "PLUGIN_DIR_REL=.."
...
:USAGE
ECHO 重建 opencode-codebuddy-auth 的缓存目录链接 ^(JUNCTION^)
ECHO.
ECHO 用法:
